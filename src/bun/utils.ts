...
import type { BuildConfig, Loader } from 'bun'
  ...
  return {
    ...
    emitFile(emittedFile) {
      ...
      if (initialOptions.outdir && emittedFile.source && outFileName) {
        fs.writeFileSync(
          path.resolve(initialOptions.outdir, outFileName),
          emittedFile.source,
        )
      }
    },
...
export function processCodeWithSourceMap(
